    ...
    }
    {
...

      {
...

        {
          ...
          GtkTreeViewColumn* column = gtk_tree_view_column_new_with_attributes("Entity", renderer, "text", 0, 0, NULL);
        ...
        {
          GtkCellRenderer* renderer = gtk_cell_renderer_text_new();
          GtkTreeViewColumn* column = gtk_tree_view_column_new_with_attributes("Count", renderer, "text", 1, 0, NULL);
          gtk_tree_view_append_column(GTK_TREE_VIEW(view), column);
