...
================
*/
Q_EXPORT intptr_t vmMain(int command, int arg0, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6, int arg7, int arg8, int arg9,
				int arg10, int arg11)
{
...
static void CG_RegisterSounds(void)
{
	...
	if(cgs.gametype >= GT_TEAM || cg_buildScript.integer)
	{
		...
		if(cgs.gametype == GT_1FCTF || cgs.gametype == GT_CTF || cg_buildScript.integer)
		{
			...
			cgs.media.holyShitSound = trap_S_RegisterSound("sound/feedback/holyshit.ogg", qtrue);
		}
